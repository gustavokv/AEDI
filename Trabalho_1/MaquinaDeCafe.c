...
int main () {
    ...
    while(pes1<0||pes1>1000) {
        printf("Numero de pessoas deve estar entre 0 e 1000!\nDigite novamente:\n");
        scanf("%d", &pes1);
    }
    
    printf("Digite a quantidade de pessoas no andar 2:\n");
    scanf("%d", &pes2);
    ...
    printf("Digite a quantidade de pessoas no andar 3:\n");
    scanf("%d", &pes3);
    ...
    if(a1==0&&a2==0&&a3==0) {
        printf("Nenhuma maquina necessaria!");
    }
    else {
        if(a1==a2&&a2==a3) {
            printf("Tempo: %d\n", a2);
            ...
            if(a1==a2) {
                ...
                printf("Maquina localizada no(s) andar(es): 1");
            }
        }
        else if(a2<=a1&&a2<=a3) {
            printf("Tempo: %d\n", a2);
            ...
            printf("Tempo: %d\n", a3);
            printf("Maquina localizada no(s) andar(es): 3");
        }
    }
